<?php
    ...
    */
    ...
    if (!$mysqli) {
        die('Could not connnect: '.mysqli_error($mysqli));
    }
    ...
    $query = "CREATE TABLE FROM INVENTORY
    ...
    {
        echo "<p>Error inserting Honda Pilot: ".mysqli_error($mysqli)."</p>";
        echo "<p>***********</p>";
        echo $query;
        echo "<p>***********</p>";
    }
    ...
    {
        echo "<p>Error inserting Dodge: ".mysqli_error($mysqli)."</p>";
        echo "<p>***********</p>";
        echo $query;
        echo "<p>***********</p>";
    }
